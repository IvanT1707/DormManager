      ...
      {approvedSettlement && !activeResidence ? (
        <section className="setup-banner student-guide">
          <div>
            ...
            <p>
              Подайте коменданту необхідні документи. Після перевірки документів,
              проходження інструктажу й оформлення перепустки поселення буде
              активовано, а нарахування з’являться у вашому кабінеті.
            </p>
          </div>
        </section>
      ) : null}
